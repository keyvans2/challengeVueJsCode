      ...
      <nav>
        <ul>
          <li>
            ...
            <lang-money-unit class="secondLy" />
          </li>
          <li>
            <svg
              aria-hidden="true"
            ...
            <logged-in-user-controler class="secondLy" />
          </li>
          <li class="toggleBtn" @click="fadeRightMenu">
...
<script>
import langMoneyUnit from "~/components/langMoneyUnit/langMoneyUnit";
import loggedInUserControler from "~/components/loggedInUserControlerLay/loggedInUserControlerLay";

export default {
  components: {
    langMoneyUnit,
    loggedInUserControler,
  },
  methods: {
    fadeRightMenu() {
      this.$emit("acardeon", true);
    },
  },
};
</script>
