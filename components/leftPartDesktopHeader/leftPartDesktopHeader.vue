...
<script>
import secondLayDesktop from "~/components/secondLayDesktop/secondLayDesktop";
...
export default {
  data() {
    return {
      //   test: ["پیام جدید", "لیست پیام ها"],

      navs: [
        {
          title: "پیام به پشتیبانی",
          submenus: ["لیست پیام ها", "پیام جدید"],
        },
        {
          title: "سفارشات",
          submenus: ["سفارشات باز ", "تاریخچه سفارشات", "تاریخچه معاملات"],
          bullet: true,
        },
        {
          title: "کیف پول",
          submenus: ["موجودی", " واریز ", "برداشت"],
          bullet: true,
        },
        // {
        //   title: "فا/تومان",
        //   languages: ["فارسی", "English"],
        //   moneyUnit: ["دلار", "تومان", "لیر"],
        //   globe: true,
        // },
      ],
    };
